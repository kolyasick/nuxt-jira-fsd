...
import { formProjectTitleSchema, type ProjectTitleForm } from "~/entities/project/model";
...
<template>
  <ModalLayout>
    <div class="bg-white max-w-[1200px] w-full h-[600px] rounded-md shadow-md flex items-center flex-col py-10 px-20">
      <div class="mb-4">
      ...
      <div class="h-full grid grid-cols-2 gap-5">
        <div class="flex flex-col gap-8">
          <div class="space-y-3">
            <h1 class="text-2xl font-medium text-slate-900">Name your first project</h1>
            <span
              >Projects bring your work to life, helping your team track progress, stay organized, and manage
              tasks.</span
            >
          </div>
          ...
          >
            <div>
              ...
              <div class="mt-8">
                ...
                <div class="text-sm font-light mt-2">Team Astro, Visual upgrade, Bug tracking, Product launch</div>
              </div>
            </div>
