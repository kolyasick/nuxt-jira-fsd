...
import { boardFormSchema } from "~/entities/board/model";
...
export const formCreateProjectSchema = formProjectLinkSchema
  .merge(formProjectTitleSchema)
  .merge(boardFormSchema)
  .merge(
    zod.object({
